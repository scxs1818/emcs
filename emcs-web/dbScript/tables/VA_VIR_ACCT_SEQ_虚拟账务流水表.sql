...
CREATE TABLE VA_VIR_ACCT_SEQ(
	...
	PAYER_ID  VARCHAR(32) NOT NULL COMMENT '买方编号',
	PAYER_VIRID  VARCHAR(32) NOT NULL COMMENT '买方虚拟账户编号',
	PAYER_SORT varchar(4)  NOT NULL COMMENT '买方类别',
	PAYEE_ID VARCHAR(32) NOT NULL COMMENT '卖方编号',
	PAYEE_VIRID  VARCHAR(32) NOT NULL COMMENT '卖方虚拟账户编号',
	PAYEE_SORT varchar(4)  NOT NULL COMMENT '卖方类别',
