...
public class CustRegister extends ServiceTransactionalY {
    ...
    protected void process(Map<String, Object> param) {
        ...
        //3.生成会员编号
        param.put("status","N");
        String cust_id = Role.CUST.vaue()+param.get("plat_id")+ oneSelect.getNextVal(Quence.CUST.gname());
        ...
        String acct_id = AcctProperty.ACCT_BAN.value()+Role.PLAT.vaue()+ oneSelect.getNextVal(Quence.PLAT_BANK.gname());
